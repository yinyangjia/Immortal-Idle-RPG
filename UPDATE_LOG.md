...
# [2026-02-15] - v1.5.0 (宗门崛起版本)
- **新增**: 名望系统（Reputation）。击杀怪物、首领、爬塔均可获得，用于门派职位晋升。
- **新增**: 门派系统（Sect）。达到境界要求后可加入青云门或魔天宗。
- **新增**: 职位晋升。消耗名望可从“外门弟子”一路晋升至“宗门长老”，解锁高级奖励。
- **新增**: 功法系统（Skill）。通过门派兑换或商城购买秘籍，学习后在战斗中自动触发。
- **新增**: 功法战斗交互。技能包含【烈火剑】（2倍暴击）、【寒冰刺】（3倍暴击）、【回春功】（每回合百分比回血）。
- **新增**: 修为商城。万宝阁上架“灵元果”、“天灵根”，可直接服用增加大量修为。
- **修复**: 彻底重写 Battle 逻辑，支持技能判定与战斗日志回调。
- **存档**: 存档 Key 升级为 `v16_sect`，建议清理缓存重新开始以体验完整门派剧情。
